...
class DataParser():
    def __init__(self):
        ...
        self.data_split_ratio: List = [0.8, 0.2, 0.2]   # the ratio of training, validation and testing set for random split
        self.seed = 1
...
class ModelParser():
    def __init__(self):
        ...
        self.latent_dim: List[int] = [40, 40, 40, 40]   # the hidden units for each gnn layer
...
class TrainParser():
    def __init__(self):
        ...
        self.last_layer_optimizer_lr = 0.001           # the learning rate of the last layer
        self.joint_optimizer_lrs = {'features': 0.001,
                       'add_on_layers': 0.001,
                       'prototype_vectors': 0.001}      # the learning rates of the joint training optimizer
